...
export const metadata = {
  title: "Troptions Unity Token — Ecosystem Coordination Token",
  description:
...
const brand = getTroptionsSubBrand("troptions-unity-token")!;

export default function TroptionsUnityTokenPage() {
  return (
    <main className="min-h-screen bg-[#0A0A0A] text-white">
      {/* Header */}
      <div className="border-b border-[#C9A84C]/20 bg-[#0D1B2A]">
        <div className="max-w-7xl mx-auto px-6 py-10">
          <p className="text-[#C9A84C] font-mono text-xs uppercase tracking-[0.3em]">Token / Digital Asset</p>
      ...
      <div className="max-w-7xl mx-auto px-6 py-10 space-y-10">
        ...
        <div className="border border-red-700/50 bg-red-900/10 rounded-lg p-5 text-red-200 text-xs leading-relaxed">
          <strong className="block mb-1 uppercase tracking-widest text-red-400 font-mono text-[10px]">
            ⚠ Securities / Token Issuance Notice
          </strong>
          {FULL_DISCLAIMER}
          {" "}
          Token issuance may constitute a securities offering in many jurisdictions. No token minting, distribution,
          or sale may occur without completed legal review, securities counsel opinion, and board authorization.
          All token references here are informational only.
        </div>

        {/* Purpose + Role */}
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bg-[#111827] border border-gray-800 rounded-xl p-7">
            <p className="text-[#C9A84C] font-mono text-xs uppercase tracking-[0.3em] mb-3">Token Purpose</p>
            <h2 className="text-xl font-bold text-white mb-3">Ecosystem Coordination</h2>
          ...
          <div className="bg-[#111827] border border-gray-800 rounded-xl p-7">
            ...
            <h2 className="text-xl font-bold text-white mb-3">Governance &amp; Access Layer</h2>
        ...
        <section className="bg-[#111827] border border-gray-800 rounded-xl p-7">
          <p className="text-[#C9A84C] font-mono text-xs uppercase tracking-[0.3em] mb-4">Linked System Capabilities</p>
        ...
        <section className="bg-[#0D1B2A] border border-[#C9A84C]/20 rounded-xl p-7">
          <p className="text-[#C9A84C] font-mono text-xs uppercase tracking-[0.3em] mb-4">Pending Requirements</p>
