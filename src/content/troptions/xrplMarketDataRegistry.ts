...
export const XRPL_MARKET_DATA_REGISTRY: readonly XrplMarketDataRecord[] = [
  { id: "md-1", pair: "XRP / OPTKAS", venue: "XRPL DEX", lastPrice: "0.8420", change24h: "+2.1%", volume24h: "1.24M XRP", status: "simulated-live", risk: "medium" },
  ...
  { id: "md-3", pair: "OPTKAS / XRP", venue: "XRPL AMM", lastPrice: "1.1860", change24h: "+0.8%", volume24h: "980k XRP eq", status: "simulated-live", risk: "medium" },
