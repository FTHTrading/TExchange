...
export const REVENUE_MODEL: RevenueStream[] = [
  ...
  },
  {
    ...
    description: "Licensing fee for third-party operators using the Troptions OPTKAS infrastructure.",
    rateOrStructure: "TBD — annual SaaS license plus revenue share",
    currency: "USD",
    eligibilityGates: ["OPTKAS platform operational", "Licensing legal structure complete"],
    status: "evaluation",
    estimatedAnnualRevenue: null,
  },
  {
